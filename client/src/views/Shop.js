                ...
                <div className="md:flex">
                    <div className="w-full grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4 pl-5 pr-5">
                        ...
                        {items.map((item, i) => (
                            ...
                            <div key={i} className="h-[465px] rounded-xl mt-3 text-center pt-5 pb-5 bg-gray-50 border border-solid border-[#61E9B1]">
                                ...
                                <div className="bg-gray-200 rounded-full h-1 ml-6 mr-6 mb-4 dark:bg-gray-700 mt-6">
                                    <div className="bg-[#61E9B1] h-1 rounded-full dark:bg-blue-500" style={{ width: `${points.userPoints / item.price * 100 > 100 ? 100 : points.userPoints / item.price * 100}%` }}></div>
                                </div>
                                <p className="text-sm">
                                    ...
                                    {item.purchased ? (
                                        ...
                                        ((item.price <= points.userPoints) ? <div className="text-[#61E9B1]">Enough!</div>
                    ...
                    <div>
                        <div className="bg-gray-50 w-72 rounded-xl mt-3 p-4 mr-6">
                            ...
                            {userItems.map((item, i) => (
                                <div key={i}>
                                    <div className="flex">
                                        <p><i className="fa-solid fa-cart-shopping"></i></p><p className="pl-2"> <b> {item.title}</b> </p>
