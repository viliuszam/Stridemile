      ...
      <div className="container pt-12">
        <div className="container md:flex mx-auto">
          <div className='container pb-10 mx-auto'>
            ...
            <p className="pb-8 text-center">You are all welcome to write a review about this product! Below there are provided a couple of reviews written by our users.</p>
            <div className="flex">
