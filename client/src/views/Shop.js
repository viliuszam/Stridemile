                        ...
                        {items.map((item) => (
                            ...
                            <div className="h-[465px] rounded-xl mt-3 text-center pt-5 pb-5 bg-gray-50 border border-solid border-[#61E9B1]">
                                <div className="rounded-4xl pb-3 flex">
                                    <img src={item.image_url} alt="Item" className="rounded-4xl mx-auto object-cover h-28 w-full mx-6 bg-gray-100 items-center justify-center flex text-gray-500" />
                                </div>
