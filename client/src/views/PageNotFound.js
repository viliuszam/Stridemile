...
export default () => {
  ...
  return (
    ...
    <div className="container bg-white pt-8 pb-6 text-center mx-auto">
        ...
        <Link to="/" className="bg-[#61E9B1] rounded-lg text-white p-3 m-2 text-sm hover:bg-white hover:text-[#61E9B1] border border-solid border-[#61E9B1]">
        Back to home
        </Link>
        ...
        <div className="flex">
            <div className="ml-auto mr-auto pl-2 pr-2">
                ...
                <Link to="/groups" className="bg-[#61E9B1] rounded-lg text-white p-3 m-2 text-sm hover:bg-white hover:text-[#61E9B1] border border-solid border-[#61E9B1]">
                Groups
                </Link>
            </div>
            <div className="ml-auto mr-auto pl-2 pr-2">
                ...
                <Link to="/events" className="bg-[#61E9B1] rounded-lg text-white p-3 m-2 text-sm hover:bg-white hover:text-[#61E9B1] border border-solid border-[#61E9B1]">
                Events
                </Link>
            </div>
            <div className="ml-auto mr-auto pl-2 pr-2">
                ...
                <Link to="/achievements" className="bg-[#61E9B1] rounded-lg text-white p-3 m-2 text-sm hover:bg-white hover:text-[#61E9B1] border border-solid border-[#61E9B1]">
                Achievements
                </Link>
            </div>
            <div className="ml-auto mr-auto pl-2 pr-2">
                ...
                <Link to="/aboutus" className="bg-[#61E9B1] rounded-lg text-white p-3 m-2 text-sm hover:bg-white hover:text-[#61E9B1] border border-solid border-[#61E9B1]">
                About us
                </Link>
            </div>
        </div>
